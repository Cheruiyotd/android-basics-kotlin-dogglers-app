...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        val dogImage: ImageView? = view?.findViewById(R.id.image_view_dog)
        val dogName: TextView? = view?.findViewById(R.id.text_view_name)
        val dogAge: TextView? = view?.findViewById(R.id.text_view_age)
        val dogHobbies: TextView? = view?.findViewById(R.id.text_view_hobbies)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        val myLayout: Int = if (mLayout == Layout.GRID) {
